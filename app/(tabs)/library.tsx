...
const styles = StyleSheet.create({
  ...
  articleCardEmoji: { fontSize: 32 },
  articleCardTitle: { fontSize: 15, fontWeight: "800", textAlign: "right", lineHeight: 22 },
  articleMeta: { flexDirection: "row-reverse", gap: 10, marginTop: 4, alignItems: "center" },
  articleCategory: { fontSize: 11, fontWeight: "700" },
  articleReadTime: { fontSize: 11 },
  ...
  articleBadgeText: { fontSize: 12, fontWeight: "700" },
  articleTitleRow: { flexDirection: "row-reverse", gap: 12, alignItems: "flex-start", marginBottom: 12 },
  articleTitleEmoji: { fontSize: 40 },
  articleTitle: { fontSize: 20, fontWeight: "900", flex: 1, textAlign: "right", lineHeight: 28 },
  ...
  articleContent: { fontSize: 14, lineHeight: 24, textAlign: "right" },
  ...
  protocolIconText: { fontSize: 26 },
  protocolTitle: { fontSize: 15, fontWeight: "800", textAlign: "right" },
  protocolMeta: { fontSize: 12, marginTop: 3, textAlign: "right" },

  // Protocol Detail
  protocolDetailBanner: { padding: 20, alignItems: "center", gap: 8 },
  protocolDetailEmoji: { fontSize: 48 },
  protocolDetailTitle: { fontSize: 20, fontWeight: "900", textAlign: "center" },
  protocolDuration: { fontSize: 13 },
  ...
  foodSectionTitle: { fontSize: 14, fontWeight: "800", textAlign: "right", marginBottom: 8 },
  ...
  warningText: { flex: 1, fontSize: 12, lineHeight: 18, textAlign: "right" },
  labRow: { flexDirection: "row-reverse", alignItems: "center", gap: 10, padding: 12, borderRadius: 12, borderWidth: 1 },
  labName: { fontSize: 14, fontWeight: "600" },

  // Food Alternatives
  foodAltCard: { borderRadius: 12, padding: 12, borderWidth: 1 },
  foodAltSupp: { fontSize: 14, fontWeight: "800", textAlign: "right", marginBottom: 8 },
  ...
  foodAltChipText: { fontSize: 11, fontWeight: "600" },
  ...
  wadaBadgeText: { fontSize: 11, fontWeight: "800" },
  wadaName: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  wadaCategory: { fontSize: 11, textAlign: "right", marginTop: 2 },
  wadaNote: { fontSize: 12, textAlign: "right", lineHeight: 18 },
  ...
  veganStatusText: { fontSize: 11, fontWeight: "800" },
  veganName: { fontSize: 14, fontWeight: "800", flex: 1, textAlign: "right" },
  veganNote: { fontSize: 12, textAlign: "right", lineHeight: 18 },
});
