...
const styles = StyleSheet.create({
  ...
  toolLabel: { fontSize: 13, fontWeight: "600", fontFamily: "Cairo-Bold" },
  ...
  sectionLabel: { fontSize: 13, fontWeight: "600", textAlign: "right", marginBottom: 10, fontFamily: "Cairo-Bold" },
  input: { borderWidth: 1, borderRadius: 10, padding: 12, fontSize: 15, fontFamily: "Cairo" },
  ...
  nutrientText: { fontSize: 13, fontWeight: "600", fontFamily: "Cairo-Bold" },
  resultCard: { borderRadius: 16, padding: 16, borderWidth: 1.5, gap: 10 },
  resultTitle: { fontSize: 18, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  doseRow: { flexDirection: "row-reverse", gap: 10 },
  doseBox: { flex: 1, borderRadius: 12, padding: 12, alignItems: "center", gap: 4 },
  doseLabel: { fontSize: 11, fontFamily: "Cairo" },
  doseValue: { fontSize: 20, fontWeight: "900", fontFamily: "Cairo-Black" },
  noteBox: { flexDirection: "row-reverse", alignItems: "flex-start", gap: 8, padding: 10, borderRadius: 10 },
  noteText: { flex: 1, fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  timingBox: { flexDirection: "row-reverse", alignItems: "center", gap: 8, padding: 10, borderRadius: 10, borderWidth: 1 },
  timingText: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
  questionCard: { borderRadius: 14, padding: 14, borderWidth: 1 },
  questionText: { fontSize: 14, fontWeight: "600", textAlign: "right", lineHeight: 22, marginBottom: 12, fontFamily: "Cairo-Bold" },
  answerRow: { flexDirection: "row-reverse", gap: 10 },
  answerBtn: { flex: 1, padding: 10, borderRadius: 10, borderWidth: 1, alignItems: "center" },
  answerText: { fontSize: 14, fontWeight: "700", fontFamily: "Cairo-Bold" },
  primaryBtn: { padding: 16, borderRadius: 14, alignItems: "center" },
  primaryBtnText: { color: "#fff", fontSize: 16, fontWeight: "800", fontFamily: "Cairo-Black" },
  secondaryBtn: { padding: 14, borderRadius: 14, alignItems: "center", borderWidth: 1 },
  secondaryBtnText: { fontSize: 14, fontWeight: "600", fontFamily: "Cairo-Bold" },
  resultHeader: { flexDirection: "row-reverse", alignItems: "center", gap: 10, padding: 14, borderRadius: 14, borderWidth: 1 },
  resultHeaderText: { fontSize: 16, fontWeight: "700", flex: 1, textAlign: "right", fontFamily: "Cairo-Bold" },
  emptyState: { alignItems: "center", padding: 40, gap: 12 },
  emptyTitle: { fontSize: 18, fontWeight: "700", fontFamily: "Cairo-Bold" },
  emptyDesc: { fontSize: 13, textAlign: "center", lineHeight: 20, fontFamily: "Cairo" },
  ...
  deficiencyRankText: { fontSize: 14, fontWeight: "800", fontFamily: "Cairo-Black" },
  deficiencyName: { fontSize: 15, fontWeight: "700", fontFamily: "Cairo-Bold" },
  deficiencyCount: { fontSize: 12, marginTop: 2, fontFamily: "Cairo" },
  ...
  refTitle: { fontSize: 14, fontWeight: "800", textAlign: "right", padding: 12, paddingBottom: 8, fontFamily: "Cairo-Black" },
  ...
  refName: { fontSize: 12, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  refNote: { fontSize: 10, textAlign: "right", marginTop: 2, fontFamily: "Cairo" },
  refRange: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  labInput: { borderWidth: 1, borderRadius: 12, padding: 14, fontSize: 13, minHeight: 140, fontFamily: "Cairo" },
  ...
  analysisResultTitle: { fontSize: 14, fontWeight: "800", fontFamily: "Cairo-Black" },
  analysisResultText: { fontSize: 13, lineHeight: 22, textAlign: "right", padding: 12, fontFamily: "Cairo" },
  // Glossary
  ...
  searchInput: { flex: 1, fontSize: 15, fontFamily: "Cairo" },
  ...
  glossaryAr: { fontSize: 15, fontWeight: "800", fontFamily: "Cairo-Black" },
  glossaryEn: { fontSize: 12, fontFamily: "Cairo" },
  glossaryDef: { fontSize: 13, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
  // Bio Forms
  bioCard: { borderRadius: 14, padding: 14, borderWidth: 1 },
  bioMineral: { fontSize: 16, fontWeight: "800", textAlign: "right", marginBottom: 10, fontFamily: "Cairo-Black" },
  ...
  bioBadgeText: { fontSize: 11, fontWeight: "600", flex: 1, textAlign: "right", fontFamily: "Cairo-Bold" },
  bioNote: { flexDirection: "row-reverse", alignItems: "flex-start", gap: 6, padding: 8, borderRadius: 8 },
  bioNoteText: { flex: 1, fontSize: 11, lineHeight: 16, textAlign: "right", fontFamily: "Cairo" },
  // BMI
  ...
  bmiValue: { fontSize: 28, fontWeight: "900", fontFamily: "Cairo-Black" },
  bmiUnit: { fontSize: 12, fontFamily: "Cairo" },
  bmiCategory: { fontSize: 18, fontWeight: "800", fontFamily: "Cairo-Black" },
  ...
  bmiScaleLabel: { fontSize: 12, fontWeight: "600", width: 50, fontFamily: "Cairo-Bold" },
  bmiScaleRange: { fontSize: 11, fontFamily: "Cairo" },
  // Lifestyle
  lifestyleOption: { padding: 12, borderRadius: 10, borderWidth: 1, alignItems: "flex-end" },
  lifestyleOptionText: { fontSize: 14, fontWeight: "600", fontFamily: "Cairo-Bold" },
  lifestyleResult: { borderRadius: 16, padding: 20, borderWidth: 1.5, alignItems: "center", gap: 8 },
  lifestyleResultEmoji: { fontSize: 48, fontFamily: "Cairo" },
  lifestyleScore: { fontSize: 36, fontWeight: "900", fontFamily: "Cairo-Black" },
  lifestyleCategory: { fontSize: 18, fontWeight: "800", fontFamily: "Cairo-Black" },
  ...
  interactionName: { fontSize: 13, fontWeight: "800", flex: 1, textAlign: "center", fontFamily: "Cairo-Black" },
  interactionBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
  interactionBadgeText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  interactionNote: { fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  // Fatigue
  fatigueResult: { borderRadius: 16, padding: 20, borderWidth: 1.5, alignItems: "center", gap: 8 },
  fatigueLevel: { fontSize: 20, fontWeight: "900", fontFamily: "Cairo-Black" },
  fatigueScore: { fontSize: 14, fontFamily: "Cairo" },
  fatigueSuppCard: { borderRadius: 12, padding: 12, borderWidth: 1, gap: 4 },
  fatigueSuppName: { fontSize: 14, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  fatigueSuppDose: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
  fatigueSuppReason: { fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  // Extra Tool Cards
  extraToolCard: { flexDirection: "row-reverse", alignItems: "center", gap: 12, padding: 14, borderRadius: 14, borderWidth: 1 },
  extraToolLabel: { flex: 1, fontSize: 14, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
});
