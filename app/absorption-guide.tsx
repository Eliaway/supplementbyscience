...
const styles = StyleSheet.create({
  ...
  absorptionText: { fontSize: 11, fontWeight: "800", fontFamily: "Cairo-Black" },
  absorptionLabel: { fontSize: 10, fontFamily: "Cairo" },
  ...
  enhancerName: { fontSize: 12, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  enhancerMechanism: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
  boostBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  boostText: { fontSize: 12, fontWeight: "900", fontFamily: "Cairo-Black" },
  blockersCard: { borderRadius: 10, borderWidth: 1, padding: 10, gap: 4 },
  blockerText: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
});
