...
const styles = StyleSheet.create({
  ...
  quizBtnText: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  lessonTitle: { fontSize: 15, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  lessonSubtitle: { fontSize: 12, textAlign: "right", marginTop: 2, fontFamily: "Cairo" },
  lessonFooter: { flexDirection: "row-reverse", gap: 8 },
  levelBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  levelText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  durationBadge: { flexDirection: "row-reverse", alignItems: "center", gap: 4, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  duration: { fontSize: 11, fontFamily: "Cairo" },
  ...
  lessonParaText: { fontSize: 14, lineHeight: 22, textAlign: "right", fontFamily: "Cairo" },
  ...
  mythText: { flex: 1, fontSize: 15, fontWeight: "700", textAlign: "right", lineHeight: 22, fontFamily: "Cairo-Bold" },
  revealBtn: { alignItems: "center", padding: 10, borderRadius: 10 },
  revealBtnText: { fontSize: 13, fontWeight: "700", fontFamily: "Cairo-Bold" },
  verdictBadge: { alignSelf: "flex-end", paddingHorizontal: 14, paddingVertical: 6, borderRadius: 10 },
  verdictText: { fontSize: 14, fontWeight: "900", fontFamily: "Cairo-Black" },
  mythExplanation: { fontSize: 13, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
  mythSource: { fontSize: 11, textAlign: "right", fontStyle: "italic", fontFamily: "Cairo" },
});
