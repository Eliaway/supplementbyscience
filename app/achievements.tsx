...
const styles = StyleSheet.create({
  ...
  levelName: { fontSize: 20, fontWeight: "900", textAlign: "right" },
  levelPoints: { fontSize: 14, fontWeight: "700", textAlign: "right" },
  ...
  achievementTitle: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  achievementDesc: { fontSize: 12, textAlign: "right" },
