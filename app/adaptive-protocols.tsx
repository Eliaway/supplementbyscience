...
const styles = StyleSheet.create({
  ...
  protoTitle: { flex: 1, fontSize: 14, fontWeight: "800", textAlign: "right" },
  ...
  suppDose: { fontSize: 12, fontWeight: "700", textAlign: "right" },
  suppBenefit: { fontSize: 12, lineHeight: 18, textAlign: "right" },
  tipsTitle: { fontSize: 13, fontWeight: "800", textAlign: "right" },
  tipRow: { flexDirection: "row-reverse", alignItems: "flex-start", gap: 6 },
  tipText: { fontSize: 11, textAlign: "right", flex: 1 },
});
