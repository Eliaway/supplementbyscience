...
const styles = StyleSheet.create({
  ...
  wadaText: { flex: 1, fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  ...
  sportTitle: { flex: 1, fontSize: 13, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  ...
  phaseTitle: { fontSize: 12, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
