...
const styles = StyleSheet.create({
  ...
  brandName: { fontSize: 14, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  brandSpecialty: { fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  certsRow: { flexDirection: "row-reverse", flexWrap: "wrap", gap: 6 },
  certBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  certText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  certCard: { borderRadius: 14, borderWidth: 1, overflow: "hidden" },
  certHeader: { padding: 10 },
  certName: { fontSize: 13, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  certDesc: { padding: 10, fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  redFlagsCard: { borderRadius: 14, padding: 14, borderWidth: 1, gap: 8 },
  redFlag: { fontSize: 12, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
});
