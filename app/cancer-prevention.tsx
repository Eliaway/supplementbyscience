...
const styles = StyleSheet.create({
  ...
  foodCompound: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  foodNote: { fontSize: 10, textAlign: "center", lineHeight: 14, fontFamily: "Cairo" },
  ...
  warningBadgeText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
});
