...
const styles = StyleSheet.create({
  ...
  certLogo: { fontSize: 24, fontFamily: "Cairo" },
  certName: { fontSize: 16, fontWeight: "900", fontFamily: "Cairo-Black" },
  ...
  certDesc: { fontSize: 13, textAlign: "right", lineHeight: 20, fontFamily: "Cairo" },
  meansSection: { gap: 6 },
  meansRow: { flexDirection: "row-reverse", alignItems: "center", gap: 6 },
  meansText: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
  bestForRow: { borderRadius: 8, padding: 8, flexDirection: "row-reverse", alignItems: "center" },
  bestForLabel: { fontSize: 12, fontWeight: "800", fontFamily: "Cairo-Black" },
  bestForText: { fontSize: 12, flex: 1, textAlign: "right", fontFamily: "Cairo" },
  ...
  riskText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  flagName: { fontSize: 13, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  flagDesc: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
});
