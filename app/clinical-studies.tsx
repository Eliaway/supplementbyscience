...
const styles = StyleSheet.create({
  ...
  studyTitle: { fontSize: 15, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  studyConsensus: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
  studyIcon: { width: 46, height: 46, borderRadius: 23, alignItems: "center", justifyContent: "center" },
  timelineTitle: { fontSize: 13, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  ...
  yearText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  findingText: { flex: 1, fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
});
