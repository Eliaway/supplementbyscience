...
const styles = StyleSheet.create({
  ...
  challengeTitle: { fontSize: 13, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  challengeMeta: { flexDirection: "row-reverse", gap: 12 },
  challengeDays: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
  challengeParticipants: { fontSize: 12, fontFamily: "Cairo" },
  progressBar: { height: 4, borderRadius: 2, overflow: "hidden" },
  progressFill: { height: 4, borderRadius: 2 },
  joinBtn: { borderRadius: 12, padding: 14, alignItems: "center" },
  joinBtnText: { color: "#fff", fontSize: 14, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  advisorInitial: { fontSize: 20, fontWeight: "800", fontFamily: "Cairo-Black" },
  advisorName: { fontSize: 14, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  advisorSpec: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
  advisorMeta: { flexDirection: "row-reverse", gap: 12 },
  advisorReviews: { fontSize: 11, fontFamily: "Cairo" },
  ...
  consultBtnText: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  hotText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  discussTitle: { fontSize: 13, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  discussMeta: { flexDirection: "row-reverse", gap: 12 },
  discussViews: { fontSize: 11, fontFamily: "Cairo" },
  discussReplies: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
});
