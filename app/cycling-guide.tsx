...
const styles = StyleSheet.create({
  ...
  reasonTitle: { fontSize: 13, fontWeight: "800", textAlign: "right" },
  reasonDesc: { fontSize: 12, lineHeight: 18, textAlign: "right" },
