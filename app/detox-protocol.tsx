...
const styles = StyleSheet.create({
  ...
  organBtnText: { fontSize: 11, fontWeight: "800", marginTop: 2 },
  organCard: { borderRadius: 14, borderWidth: 1, padding: 14, gap: 10 },
  organTitle: { fontSize: 16, fontWeight: "900", textAlign: "right" },
  phaseLabel: { fontSize: 12, fontWeight: "800", textAlign: "right" },
  ...
  tipsText: { fontSize: 11, lineHeight: 16, textAlign: "right" },
  ...
  metalName: { fontSize: 13, fontWeight: "800", textAlign: "right" },
  metalSources: { fontSize: 10, textAlign: "right", flex: 1 },
  chelatorLabel: { fontSize: 12, fontWeight: "700", textAlign: "right" },
});
