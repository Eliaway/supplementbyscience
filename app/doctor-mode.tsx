...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  emptyText: { fontSize: 12, lineHeight: 18, textAlign: "right", marginTop: 4 },
  fillBtn: { borderRadius: 10, padding: 10, alignItems: "center", marginTop: 10 },
  fillBtnText: { color: "#fff", fontSize: 13, fontWeight: "700" },
  ...
  pharmacistTitle: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  pharmacistText: { fontSize: 12, lineHeight: 18, textAlign: "right", marginTop: 4 },
});
