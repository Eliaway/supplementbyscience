...
const styles = StyleSheet.create({
  ...
  heroText: { fontSize: 13, lineHeight: 20, textAlign: "right" },
  ...
  formulaName: { fontSize: 16, fontWeight: "800", textAlign: "right" },
  formulaRange: { fontSize: 12, textAlign: "right", marginTop: 2 },
  sectionTitle: { fontSize: 15, fontWeight: "800", textAlign: "right" },
  inputCard: { borderRadius: 14, padding: 14, borderWidth: 1, gap: 12 },
  inputLabel: { fontSize: 15, fontWeight: "800", textAlign: "right" },
  ...
  input: { fontSize: 24, fontWeight: "800", width: "100%", textAlign: "center" },
  conditionCard: { borderRadius: 12, padding: 12, borderWidth: 1 },
  conditionRow: { flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  conditionTitle: { fontSize: 13, fontWeight: "700", textAlign: "right" },
  conditionNote: { fontSize: 11, textAlign: "right" },
  multiplierBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  multiplierText: { fontSize: 12, fontWeight: "800" },
  ...
  resultDose: { fontSize: 36, fontWeight: "900" },
  resultTiming: { fontSize: 13, fontWeight: "700" },
  resultRange: { borderRadius: 8, padding: 8, alignSelf: "stretch" },
  resultRangeText: { fontSize: 12, textAlign: "center" },
  resultNotes: { fontSize: 12, lineHeight: 18, textAlign: "right" },
