...
const styles = StyleSheet.create({
  ...
  searchInput: { borderRadius: 12, borderWidth: 1, padding: 12, fontSize: 13 },
  ...
  resultCount: { fontSize: 11, textAlign: "right" },
  ...
  drugName: { fontSize: 12, fontWeight: "700" },
  plus: { fontSize: 12, fontWeight: "900" },
  suppName: { fontSize: 12, fontWeight: "700" },
  ...
  mechanismLabel: { fontSize: 10, fontWeight: "700", textAlign: "right" },
  mechanismText: { fontSize: 11, lineHeight: 16, textAlign: "right", marginTop: 2 },
  recBox: { borderRadius: 8, padding: 8 },
  recLabel: { fontSize: 10, fontWeight: "700", textAlign: "right" },
  recText: { fontSize: 11, lineHeight: 16, textAlign: "right", marginTop: 2 },
});
