...
const styles = StyleSheet.create({
  ...
  disclaimerText: { fontSize: 12, lineHeight: 18, textAlign: "right" },
  ...
  factClaim: { flex: 1, fontSize: 12, fontWeight: "700", textAlign: "right" },
  verdictBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 20 },
  verdictText: { fontSize: 10, fontWeight: "700" },
  factExplanation: { fontSize: 12, lineHeight: 18, textAlign: "right" },
  factEvidence: { fontSize: 11, textAlign: "right", fontStyle: "italic" },
  ...
  tipDesc: { fontSize: 11, lineHeight: 16, textAlign: "right", marginTop: 2 },
  ...
  pseudoName: { flex: 1, fontSize: 12, textAlign: "right" },
  pseudoVerdict: { fontSize: 10, fontWeight: "700" },
});
