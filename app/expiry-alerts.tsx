...
const styles = StyleSheet.create({
  ...
  summaryCount: { fontSize: 24, fontWeight: "900", fontFamily: "Cairo-Black" },
  summaryLabel: { fontSize: 10, textAlign: "center", marginTop: 2, fontFamily: "Cairo" },
  addForm: { borderRadius: 16, borderWidth: 1, padding: 14, gap: 10 },
  formTitle: { fontSize: 14, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  input: { borderRadius: 10, borderWidth: 1, padding: 10, fontSize: 13, fontFamily: "Cairo" },
  inputRow: { flexDirection: "row-reverse", gap: 8 },
  inputHalf: { flex: 1, borderRadius: 10, borderWidth: 1, padding: 10, fontSize: 13, fontFamily: "Cairo" },
  saveBtn: { borderRadius: 10, padding: 12, alignItems: "center" },
  saveBtnText: { color: "#fff", fontSize: 14, fontWeight: "700", fontFamily: "Cairo-Bold" },
  itemCard: { borderRadius: 14, borderWidth: 1, padding: 12, gap: 8 },
  itemHeader: { flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  itemName: { flex: 1, fontSize: 14, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  statusBadge: { flexDirection: "row-reverse", alignItems: "center", gap: 4, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 20 },
  statusText: { fontSize: 10, fontWeight: "700", fontFamily: "Cairo-Bold" },
  itemDetails: { gap: 4 },
  itemDetail: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
});
