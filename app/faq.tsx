...
const styles = StyleSheet.create({
  ...
  questionText: { flex: 1, fontSize: 13, fontWeight: "700", lineHeight: 20, textAlign: "right", fontFamily: "Cairo-Bold" },
  answerText: { padding: 12, fontSize: 12, lineHeight: 20, textAlign: "right", borderTopWidth: 0.5, fontFamily: "Cairo" },
});
