...
const styles = StyleSheet.create({
  ...
  protocolName: { fontSize: 15, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  protocolDesc: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
  diffBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  diffText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  timeBadgeText: { color: "#fff", fontSize: 13, fontWeight: "800", fontFamily: "Cairo-Black" },
  exampleText: { fontSize: 13, textAlign: "center", fontFamily: "Cairo" },
  benefitRow: { borderRadius: 12, padding: 12, borderWidth: 1, flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  benefitText: { flex: 1, fontSize: 13, textAlign: "right", fontFamily: "Cairo" },
  ...
  breakName: { fontSize: 14, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  breakReason: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
  breakBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8, flexShrink: 0 },
  breakBadgeText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
});
