...
const styles = StyleSheet.create({
  ...
  foodName: { fontSize: 14, fontWeight: "700", textAlign: "right" },
  foodReason: { fontSize: 12, textAlign: "right" },
  ...
  ruleName: { fontSize: 15, fontWeight: "800", textAlign: "right" },
  ruleTime: { fontSize: 12, textAlign: "right" },
