...
const styles = StyleSheet.create({
  ...
  cardTitle: { flex: 1, fontSize: 15, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  ...
  formName: { flex: 1, fontSize: 12, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  formRating: { fontSize: 11, fontFamily: "Cairo" },
  ...
  formBestFor: { flex: 1, fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
  sideEffects: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
});
