...
const styles = StyleSheet.create({
  ...
  prevalenceText: { fontSize: 10, fontWeight: "700", fontFamily: "Cairo-Bold" },
  description: { fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  ...
  supplementName: { fontSize: 12, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  supplementDose: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
  supplementNote: { fontSize: 11, textAlign: "right", maxWidth: 100, fontFamily: "Cairo" },
  avoidText: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
});
