...
const styles = StyleSheet.create({
  ...
  introText: { flex: 1, fontSize: 13, lineHeight: 22, textAlign: "right" },
  sectionTitle: { fontSize: 16, fontWeight: "800", textAlign: "right" },
  factCard: { width: 180, padding: 14, borderRadius: 14, borderWidth: 1, gap: 8 },
  factNum: { fontSize: 20, fontWeight: "800" },
  factText: { fontSize: 12, lineHeight: 18, textAlign: "right" },
  ...
  sectionCardDesc: { fontSize: 12, marginTop: 2, textAlign: "right" },
  ...
  suppEffect: { fontSize: 12, lineHeight: 18, textAlign: "right" },
});
