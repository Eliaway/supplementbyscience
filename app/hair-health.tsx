...
const styles = StyleSheet.create({
  ...
  causesTitle: { flex: 1, fontSize: 14, fontWeight: "800", textAlign: "right" },
  causeRow: { flexDirection: "row-reverse", gap: 8, paddingBottom: 8, borderBottomWidth: 0.5 },
  causeName: { flex: 1, fontSize: 12, fontWeight: "700", textAlign: "right" },
  causeTest: { fontSize: 11, color: "#888" },
  causeFix: { fontSize: 11, fontWeight: "600" },
