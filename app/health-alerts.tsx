...
const styles = StyleSheet.create({
  ...
  alertTitle: { fontSize: 13, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  alertDesc: { fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  actionBtn: { alignSelf: "flex-end", paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  actionBtnText: { color: "#fff", fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  daysNum: { fontSize: 20, fontWeight: "900", fontFamily: "Cairo-Black" },
  daysLabel: { fontSize: 10, fontWeight: "700", fontFamily: "Cairo-Bold" },
  expiryName: { fontSize: 13, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  expiryDate: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
  urgentText: { fontSize: 11, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  ...
  notifTitle: { fontSize: 13, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  notifDesc: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
});
