...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 15, fontWeight: "800", textAlign: "right" },
  ...
  testName: { fontSize: 13, fontWeight: "800", textAlign: "right" },
  testFreq: { fontSize: 10, textAlign: "right", marginTop: 2 },
  ...
  rangeValue: { fontSize: 11, flex: 1, textAlign: "right" },
  suppLabel: { fontSize: 11, fontWeight: "700", textAlign: "right" },
