...
const styles = StyleSheet.create({
  ...
  sectionSubtitle: { fontSize: 12, marginTop: 2, fontFamily: "Cairo" },
  ...
  phaseName: { fontSize: 13, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  phaseDesc: { fontSize: 11, textAlign: "right", marginTop: 2, fontFamily: "Cairo" },
  ...
  suppReason: { fontSize: 11, lineHeight: 16, textAlign: "right", fontFamily: "Cairo" },
