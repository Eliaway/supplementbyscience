...
const styles = StyleSheet.create({
  ...
  categoryTitle: { fontSize: 15, fontWeight: "800", textAlign: "right", marginBottom: 4 },
  ...
  questionText: { flex: 1, fontSize: 13, lineHeight: 20, textAlign: "right" },
  ...
  suppDose: { fontSize: 13, fontWeight: "600", textAlign: "right" },
  ...
  labTitle: { fontSize: 14, fontWeight: "800", textAlign: "right", marginBottom: 6 },
  labText: { fontSize: 12, lineHeight: 20, textAlign: "right" },
});
