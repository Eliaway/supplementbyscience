...
const styles = StyleSheet.create({
  ...
  warningText: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
  ...
  foodName: { fontSize: 14, fontWeight: "800", fontFamily: "Cairo-Black" },
  foodAmount: { fontSize: 12, fontWeight: "600", fontFamily: "Cairo-Bold" },
  foodNote: { fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
});
