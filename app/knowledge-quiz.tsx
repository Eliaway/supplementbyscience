...
const styles = StyleSheet.create({
  ...
  scoreBadgeText: { fontSize: 13, fontWeight: "800", fontFamily: "Cairo-Black" },
  ...
  categoryText: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
  question: { fontSize: 18, fontWeight: "800", textAlign: "right", lineHeight: 28, fontFamily: "Cairo-Black" },
  ...
  optionText: { flex: 1, fontSize: 14, fontWeight: "600", textAlign: "right", lineHeight: 20, fontFamily: "Cairo-Bold" },
  explanation: { flexDirection: "row-reverse", gap: 10, padding: 14, borderRadius: 12, borderWidth: 1 },
  explanationText: { flex: 1, fontSize: 13, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
  nextBtn: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 8, padding: 16, borderRadius: 14 },
  nextBtnText: { color: "#fff", fontSize: 16, fontWeight: "800", fontFamily: "Cairo-Black" },
  ...
  scorePct: { fontSize: 14, fontWeight: "600", fontFamily: "Cairo-Bold" },
  levelLabel: { fontSize: 20, fontWeight: "900", fontFamily: "Cairo-Black" },
  resultRow: { flexDirection: "row-reverse", alignItems: "center", gap: 10, padding: 10, borderRadius: 10, borderWidth: 1 },
  resultQ: { flex: 1, fontSize: 13, textAlign: "right", fontFamily: "Cairo" },
  restartBtn: { flexDirection: "row-reverse", alignItems: "center", gap: 8, paddingHorizontal: 24, paddingVertical: 14, borderRadius: 14 },
  restartBtnText: { color: "#fff", fontSize: 16, fontWeight: "800", fontFamily: "Cairo-Black" },
});
