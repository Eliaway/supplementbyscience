...
const styles = StyleSheet.create({
  ...
  stepTitle: { fontSize: 13, fontWeight: "800", textAlign: "right" },
  stepDesc: { fontSize: 11, lineHeight: 16, textAlign: "right", marginTop: 2 },
  ...
  additiveName: { fontSize: 13, fontWeight: "700", textAlign: "right" },
  additiveEn: { fontSize: 10, textAlign: "right" },
  additiveInfo: { fontSize: 12, lineHeight: 18, textAlign: "right", paddingTop: 4 },
});
