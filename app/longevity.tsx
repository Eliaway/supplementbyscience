...
const styles = StyleSheet.create({
  ...
  introTitle: { fontSize: 15, fontWeight: "800", textAlign: "right", marginBottom: 8, fontFamily: "Cairo-Black" },
  introText: { fontSize: 12, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
  ...
  protocolSubtitle: { fontSize: 12, marginTop: 2, fontFamily: "Cairo" },
  protocolIcon: { width: 46, height: 46, borderRadius: 23, alignItems: "center", justifyContent: "center" },
  protocolDesc: { fontSize: 12, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
  ...
  disclaimerText: { flex: 1, fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
});
