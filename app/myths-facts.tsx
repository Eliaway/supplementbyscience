...
const styles = StyleSheet.create({
  ...
  severityText: { fontSize: 10, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  mythLabelText: { fontSize: 10, fontWeight: "800", fontFamily: "Cairo-Black" },
  mythText: { flex: 1, fontSize: 13, fontWeight: "700", textAlign: "right", lineHeight: 18, fontFamily: "Cairo-Bold" },
  factText: { flex: 1, fontSize: 13, fontWeight: "700", textAlign: "right", lineHeight: 18, fontFamily: "Cairo-Bold" },
  explanation: { borderRadius: 10, padding: 12, borderWidth: 1 },
  explanationText: { fontSize: 13, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
});
