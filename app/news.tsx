...
const styles = StyleSheet.create({
  ...
  trendName: { fontSize: 13, fontWeight: "800", textAlign: "center" },
  trendPercent: { fontSize: 16, fontWeight: "900", textAlign: "center" },
  trendReason: { fontSize: 10, textAlign: "center", lineHeight: 14 },
  ...
  newsTitle: { fontSize: 14, fontWeight: "800", lineHeight: 20, textAlign: "right" },
  newsSummary: { padding: 14, fontSize: 12, lineHeight: 18, textAlign: "right" },
});
