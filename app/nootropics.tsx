...
const styles = StyleSheet.create({
  ...
  foodName: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  foodBenefit: { fontSize: 11, lineHeight: 16, textAlign: "right" },
  ...
  stackTitle: { fontSize: 14, fontWeight: "800" },
  stackSubtitle: { fontSize: 12 },
  ...
  suppMechanism: { fontSize: 11, lineHeight: 16, textAlign: "right" },
