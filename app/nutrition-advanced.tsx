...
const styles = StyleSheet.create({
  ...
  catTitle: { flex: 1, fontSize: 14, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  countBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  countText: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
  itemCard: { borderRadius: 12, padding: 12, borderWidth: 1, gap: 4 },
  itemHeader: { flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  itemName: { flex: 1, fontSize: 13, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  itemRDA: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
  itemSources: { fontSize: 11, lineHeight: 16, textAlign: "right", fontFamily: "Cairo" },
  itemDeficiency: { fontSize: 11, lineHeight: 16, textAlign: "right", fontFamily: "Cairo" },
  itemToxicity: { fontSize: 11, lineHeight: 16, textAlign: "right", fontFamily: "Cairo" },
  foodCard: { borderRadius: 16, padding: 14, borderWidth: 1, gap: 8 },
  foodHeader: { flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  foodName: { flex: 1, fontSize: 15, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  foodCompound: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
  foodBenefit: { fontSize: 13, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
  tipBox: { flexDirection: "row-reverse", padding: 10, borderRadius: 10, borderWidth: 1, gap: 4 },
  tipLabel: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
