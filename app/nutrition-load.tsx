...
const styles = StyleSheet.create({
  ...
  nutrientName: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  ...
  input: { flex: 1, borderRadius: 10, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 8, fontSize: 16, fontWeight: "700" },
  unitText: { fontSize: 13, fontWeight: "700", minWidth: 30 },
  ...
  overFill: { height: "100%" },
  pctText: { fontSize: 12, fontWeight: "800", minWidth: 40, textAlign: "right" },
});
