...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 17, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  ...
  sectionTitle: { fontSize: 15, fontWeight: "800", fontFamily: "Cairo-Black" },
  timeBlock: { padding: 12, gap: 8 },
  timeBadge: { alignSelf: "flex-end", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  timeText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  suppList: { gap: 4 },
  suppItem: { borderRadius: 6, paddingHorizontal: 8, paddingVertical: 4 },
  suppText: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
  noteText: { fontSize: 10, textAlign: "right", fontFamily: "Cairo" },
  ...
  goalLabel: { fontSize: 11, fontWeight: "700", textAlign: "center", fontFamily: "Cairo-Bold" },
  checkBadge: { position: "absolute", top: 6, left: 6, width: 18, height: 18, borderRadius: 9, alignItems: "center", justifyContent: "center" },
  checkText: { color: "#fff", fontSize: 10, fontWeight: "900", fontFamily: "Cairo-Black" },
  recommendCard: { borderRadius: 14, borderWidth: 1, padding: 14, gap: 10 },
  recommendTitle: { fontSize: 13, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  goalRow: { gap: 6 },
  goalRowLabel: { fontSize: 11, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  ...
  dayText: { color: "#fff", fontSize: 11, fontWeight: "800", fontFamily: "Cairo-Black" },
  dayContent: { flex: 1 },
  dayFocus: { fontSize: 13, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  dayNote: { fontSize: 10, textAlign: "right", marginTop: 2, fontFamily: "Cairo" },
});
