...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 16, fontWeight: "800", textAlign: "right", marginBottom: 10 },
  ...
  optionCardTitle: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  optionCardDesc: { fontSize: 12, lineHeight: 18, textAlign: "right", marginTop: 4 },
  ...
  profileTitle: { fontSize: 14, fontWeight: "800", textAlign: "right", marginBottom: 12 },
  profileGrid: { flexDirection: "row-reverse", flexWrap: "wrap", gap: 12 },
  profileItem: { alignItems: "center", minWidth: 70 },
  profileLabel: { fontSize: 11, marginBottom: 4 },
  ...
  recName: { flex: 1, fontSize: 14, fontWeight: "800", textAlign: "right" },
  recDose: { fontSize: 13, fontWeight: "600", textAlign: "right" },
  recReason: { fontSize: 12, lineHeight: 18, textAlign: "right" },
});
