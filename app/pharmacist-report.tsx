...
const styles = StyleSheet.create({
  ...
  sectionName: { flex: 1, fontSize: 13, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  ...
  generateBtnText: { color: "#fff", fontSize: 15, fontWeight: "800", fontFamily: "Cairo-Black" },
  ...
  successText: { fontSize: 15, fontWeight: "800", fontFamily: "Cairo-Black" },
  ...
  reportDate: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
  divider: { height: 0.5, marginVertical: 4 },
  reportSection: { fontSize: 13, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  reportContent: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
  shareBtn: { borderRadius: 12, padding: 12, flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 6 },
  shareBtnText: { color: "#fff", fontSize: 13, fontWeight: "700", fontFamily: "Cairo-Bold" },
  privacyCard: { borderRadius: 12, padding: 12, borderWidth: 1, flexDirection: "row-reverse", gap: 8, alignItems: "flex-start" },
  privacyText: { flex: 1, fontSize: 11, lineHeight: 16, textAlign: "right", fontFamily: "Cairo" },
});
