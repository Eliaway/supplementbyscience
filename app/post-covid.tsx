...
const styles = StyleSheet.create({
  ...
  phaseBtnText: { fontSize: 10, fontWeight: "800", textAlign: "center", fontFamily: "Cairo-Black" },
  phaseCard: { borderRadius: 14, borderWidth: 1, padding: 14 },
  phaseTitle: { fontSize: 16, fontWeight: "900", textAlign: "right", fontFamily: "Cairo-Black" },
  phaseSub: { fontSize: 11, textAlign: "right", marginTop: 2, fontFamily: "Cairo" },
  ...
  suppNote: { fontSize: 11, textAlign: "right", marginTop: 2, fontStyle: "italic", fontFamily: "Cairo" },
  ...
  symptomName: { flex: 1, fontSize: 13, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  symptomBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 20 },
  symptomCount: { fontSize: 10, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  suppChipText: { fontSize: 11, fontWeight: "600", fontFamily: "Cairo-Bold" },
});
