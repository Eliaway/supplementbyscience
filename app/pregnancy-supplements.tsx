...
const styles = StyleSheet.create({
  ...
  warningText: { fontSize: 12, fontWeight: "700", flex: 1, textAlign: "right", fontFamily: "Cairo-Bold" },
  ...
  dangerText: { fontSize: 12, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
});
