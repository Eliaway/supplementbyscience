...
const styles = StyleSheet.create({
  ...
  tipsTitle: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  tipRow: { flexDirection: "row-reverse", gap: 8, alignItems: "flex-start" },
  tipNum: { fontSize: 12, fontWeight: "800", width: 16, textAlign: "center" },
  ...
  priceTitle: { flex: 1, fontSize: 15, fontWeight: "800", textAlign: "right" },
  ...
  valueScore: { fontSize: 12, fontWeight: "800" },
  optionBrand: { flex: 1, fontSize: 12, fontWeight: "700", textAlign: "right" },
  optionMeta: { flexDirection: "row-reverse", gap: 10 },
  optionDose: { flex: 1, fontSize: 11, textAlign: "right" },
  optionServings: { fontSize: 11 },
