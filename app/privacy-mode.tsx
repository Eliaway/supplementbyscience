...
const styles = StyleSheet.create({
  ...
  badgeTitle: { fontSize: 13, fontWeight: "800", textAlign: "right" },
  badgeSub: { fontSize: 11, textAlign: "right", marginTop: 2 },
  ...
  featureTitle: { fontSize: 13, fontWeight: "800", textAlign: "right" },
  featureSub: { fontSize: 11, textAlign: "right", marginTop: 2 },
  actionBtn: { flexDirection: "row-reverse", alignItems: "center", gap: 12, borderRadius: 14, borderWidth: 1, padding: 14 },
  actionTitle: { fontSize: 13, fontWeight: "800", textAlign: "right" },
  actionSub: { fontSize: 11, textAlign: "right", marginTop: 2 },
});
