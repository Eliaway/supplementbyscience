...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 17, fontWeight: "700", flex: 1, textAlign: "center" , fontFamily: "Cairo-Bold" },
  notFound: { flex: 1, alignItems: "center", justifyContent: "center" },
  notFoundText: { fontSize: 16 , fontFamily: "Cairo" },
  ...
  heroName: { fontSize: 18, fontWeight: "800", textAlign: "right" , fontFamily: "Cairo-Black" },
  heroBrand: { fontSize: 13 , fontFamily: "Cairo" },
  heroCatBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  heroCatText: { fontSize: 11, fontWeight: "600" , fontFamily: "Cairo-Bold" },
  heroScore: { alignItems: "center" },
  heroScoreNum: { fontSize: 32, fontWeight: "900" , fontFamily: "Cairo-Black" },
  heroScoreSub: { fontSize: 12 , fontFamily: "Cairo" },
  ...
  statVal: { fontSize: 14, fontWeight: "700", textAlign: "center" , fontFamily: "Cairo-Bold" },
  statLabel: { fontSize: 10, textAlign: "center" , fontFamily: "Cairo" },
  section: { borderRadius: 14, padding: 14, gap: 10, borderWidth: 1 },
  sectionTitle: { fontSize: 15, fontWeight: "700" , fontFamily: "Cairo-Bold" },
  ...
  scoreBarNum: { fontSize: 16, fontWeight: "700", minWidth: 40, textAlign: "center" , fontFamily: "Cairo-Bold" },
  ...
  ingScoreText: { fontSize: 13, fontWeight: "800" , fontFamily: "Cairo-Black" },
  ingInfo: { flex: 1, alignItems: "flex-end", gap: 4 },
  ingName: { fontSize: 14, fontWeight: "600" , fontFamily: "Cairo-Bold" },
  ingDose: { fontSize: 12 , fontFamily: "Cairo" },
  ingFormBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
  ingFormText: { fontSize: 10, fontWeight: "600" , fontFamily: "Cairo-Bold" },
  ...
  swTitle: { fontSize: 13, fontWeight: "700" , fontFamily: "Cairo-Bold" },
  swText: { fontSize: 12, textAlign: "right", lineHeight: 18 , fontFamily: "Cairo" },
  bodyText: { fontSize: 13, textAlign: "right", lineHeight: 20 , fontFamily: "Cairo" },
  sciNote: {
    borderRadius: 12, padding: 12, flexDirection: "row-reverse",
    gap: 10, alignItems: "flex-start", borderWidth: 1,
  },
  sciNoteText: { flex: 1, fontSize: 11, textAlign: "right", lineHeight: 17 , fontFamily: "Cairo" },
});
