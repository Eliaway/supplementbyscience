...
const styles = StyleSheet.create({
  ...
  dateText: { flex: 1, fontSize: 14, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  savedBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  savedText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ratingRow: { flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  ratingLabel: { fontSize: 14, fontWeight: "700", width: 100, textAlign: "right", fontFamily: "Cairo-Bold" },
  ...
  supplementToggleText: { fontSize: 15, fontWeight: "700", fontFamily: "Cairo-Bold" },
  notesBox: { borderRadius: 12, padding: 12, borderWidth: 1 },
  notesLabel: { fontSize: 12, marginBottom: 8, textAlign: "right", fontFamily: "Cairo" },
  notesInput: { fontSize: 14, lineHeight: 22, minHeight: 70, fontFamily: "Cairo" },
  saveBtn: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 8, padding: 16, borderRadius: 14 },
  saveBtnText: { color: "#fff", fontSize: 16, fontWeight: "800", fontFamily: "Cairo-Black" },
  emptyState: { alignItems: "center", gap: 12, padding: 40, borderRadius: 16 },
  emptyText: { fontSize: 14, textAlign: "center", fontFamily: "Cairo" },
  ...
  logDate: { fontSize: 13, fontWeight: "600", fontFamily: "Cairo-Bold" },
  ...
  logStatValue: { fontSize: 14, fontWeight: "800", fontFamily: "Cairo-Black" },
  logStatLabel: { fontSize: 10, fontFamily: "Cairo" },
  logNotes: { fontSize: 13, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  reportCard: { borderRadius: 14, padding: 16, borderWidth: 1, gap: 14 },
  reportTitle: { fontSize: 16, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  ...
  reportStatValue: { fontSize: 22, fontWeight: "900", fontFamily: "Cairo-Black" },
  reportStatLabel: { fontSize: 11, textAlign: "center", fontFamily: "Cairo" },
  insightCard: { flexDirection: "row-reverse", gap: 12, padding: 14, borderRadius: 12, borderWidth: 1 },
  insightTitle: { fontSize: 14, fontWeight: "800", textAlign: "right", marginBottom: 4, fontFamily: "Cairo-Black" },
  insightText: { fontSize: 13, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
});
