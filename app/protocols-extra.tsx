...
const styles = StyleSheet.create({
  ...
  metaText: { fontSize: 11, fontWeight: "600", fontFamily: "Cairo-Bold" },
  catChip: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, borderWidth: 1 },
  catChipText: { fontSize: 12, fontWeight: "600", fontFamily: "Cairo-Bold" },
  ...
  protocolTitle: { fontSize: 15, fontWeight: "800", fontFamily: "Cairo-Black" },
  protocolCat: { fontSize: 12, fontWeight: "600", marginTop: 2, fontFamily: "Cairo-Bold" },
  protocolDesc: { fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  ...
  suppNumText: { fontSize: 13, fontWeight: "800", fontFamily: "Cairo-Black" },
  ...
  suppBadgeText: { fontSize: 11, fontWeight: "600", fontFamily: "Cairo-Bold" },
