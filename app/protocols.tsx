...
const styles = StyleSheet.create({
  ...
  protocolName: { fontSize: 16, fontWeight: "800", textAlign: "right" },
  protocolDesc: { fontSize: 12, lineHeight: 18, textAlign: "right", marginTop: 4 },
  ...
  detailDesc: { fontSize: 13, lineHeight: 20, textAlign: "center", paddingHorizontal: 16 },
  ...
  tipText: { flex: 1, fontSize: 13, lineHeight: 20, textAlign: "right" },
  warningCard: { flexDirection: "row-reverse", alignItems: "flex-start", gap: 10, padding: 12, borderRadius: 12, borderWidth: 1 },
  warningText: { flex: 1, fontSize: 13, lineHeight: 20, textAlign: "right" },
});
