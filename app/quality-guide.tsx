...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 16, fontWeight: "800", textAlign: "right" },
  ...
  certName: { fontSize: 15, fontWeight: "800" },
  certFullName: { fontSize: 11, textAlign: "right" },
  importanceBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  importanceText: { fontSize: 10, fontWeight: "700" },
  certDesc: { fontSize: 13, lineHeight: 18, textAlign: "right" },
  tierCard: { borderRadius: 12, padding: 14, borderWidth: 1, gap: 6 },
  tierTitle: { fontSize: 15, fontWeight: "800", textAlign: "right" },
  tierDesc: { fontSize: 13, lineHeight: 18, textAlign: "right" },
  tierExamples: { fontSize: 12, textAlign: "right" },
  redFlagCard: { borderRadius: 12, padding: 12, borderWidth: 1, gap: 8 },
  redFlagTop: { flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  redFlagTitle: { fontSize: 14, fontWeight: "800", textAlign: "right", flex: 1 },
  redFlagExpl: { fontSize: 12, lineHeight: 18, textAlign: "right" },
});
