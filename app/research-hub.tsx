...
const styles = StyleSheet.create({
  ...
  sectionDesc: { fontSize: 12, lineHeight: 18, textAlign: "right" },
  ...
  levelText: { color: "white", fontSize: 20, fontWeight: "900" },
  levelDesc: { fontSize: 13, fontWeight: "700", textAlign: "right" },
  levelExamples: { fontSize: 11, lineHeight: 16, textAlign: "right" },
  ...
  studyTitle: { flex: 1, fontSize: 14, fontWeight: "800", textAlign: "right" },
  studyYear: { fontSize: 11 },
  evidenceMini: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  evidenceMiniText: { fontSize: 11, fontWeight: "700" },
  studyFinding: { fontSize: 12, lineHeight: 18, textAlign: "right" },
  studySource: { fontSize: 11, textAlign: "right" },
  mythCard: { borderRadius: 14, borderWidth: 1, overflow: "hidden" },
  mythHeader: { padding: 12 },
  mythText: { fontSize: 12, lineHeight: 18, textAlign: "right" },
  truthHeader: { padding: 12 },
  truthText: { fontSize: 12, lineHeight: 18, textAlign: "right" },
});
