...
const styles = StyleSheet.create({
  ...
  rangeLabel: { fontSize: 10, fontWeight: "700", textAlign: "right" },
  rangeValue: { fontSize: 11, fontWeight: "600", textAlign: "right" },
  toxicCard: { borderRadius: 10, borderWidth: 1, padding: 10, flexDirection: "row-reverse", gap: 6, alignItems: "flex-start" },
  toxicLabel: { fontSize: 12, fontWeight: "800" },
  toxicValue: { flex: 1, fontSize: 12, textAlign: "right" },
  ...
  noteText: { fontSize: 12, lineHeight: 18, textAlign: "right" },
});
