...
const styles = StyleSheet.create({
  ...
  sectionName: { flex: 1, fontSize: 14, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  ...
  contentItem: { fontSize: 11, textAlign: "right", lineHeight: 18, fontFamily: "Cairo" },
  shareOptions: { gap: 12 },
  shareBtn: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 8, padding: 14, borderRadius: 14 },
  shareBtnText: { color: "#fff", fontSize: 15, fontWeight: "800", fontFamily: "Cairo-Black" },
  infoCard: { borderRadius: 14, borderWidth: 1, padding: 14, gap: 8 },
  infoTitle: { fontSize: 13, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  infoText: { fontSize: 12, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
});
