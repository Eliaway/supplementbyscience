...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 14, fontWeight: "800", textAlign: "right", marginBottom: 4, fontFamily: "Cairo-Black" },
  ...
  riskName: { fontSize: 12, fontWeight: "700", minWidth: 160, textAlign: "right", fontFamily: "Cairo-Bold" },
  riskDetail: { flex: 1, fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
  ...
  protocolTime: { fontSize: 10, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  suppName: { fontSize: 12, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  suppDose: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
  suppNote: { fontSize: 11, textAlign: "right", maxWidth: 100, fontFamily: "Cairo" },
  ...
  tipText: { fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
});
