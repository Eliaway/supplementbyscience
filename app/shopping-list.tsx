...
const styles = StyleSheet.create({
  ...
  clearBtnText: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  itemName: { fontSize: 14, fontWeight: "700", textAlign: "right", fontFamily: "Cairo-Bold" },
  itemMeta: { flexDirection: "row-reverse", gap: 8, marginTop: 4, alignItems: "center" },
  itemPrice: { fontSize: 12, fontFamily: "Cairo" },
  deleteBtn: { padding: 6 },
  suggestionsTitle: { fontSize: 16, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  ...
  suggestionName: { fontSize: 14, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  suggestionNameEn: { fontSize: 11, textAlign: "right", fontFamily: "Cairo" },
  suggestionBottom: { flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  suggestionPrice: { fontSize: 12, flex: 1, textAlign: "right", fontFamily: "Cairo" },
  suggestionNotes: { fontSize: 11, flex: 1, textAlign: "right", fontFamily: "Cairo" },
  addBtn: { flexDirection: "row-reverse", alignItems: "center", gap: 4, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10 },
  addBtnText: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
