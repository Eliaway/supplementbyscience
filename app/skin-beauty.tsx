...
const styles = StyleSheet.create({
  ...
  descText: { flex: 1, fontSize: 14, lineHeight: 22, textAlign: "right" },
  ...
  tipNum: { fontSize: 18, fontWeight: "900", width: 24, textAlign: "center" },
  ...
  sectionCardTitle: { fontSize: 15, fontWeight: "800", textAlign: "right" },
  sectionCardSub: { fontSize: 12, lineHeight: 18, textAlign: "right", marginTop: 2 },
  sectionCount: { fontSize: 12, fontWeight: "700", marginTop: 4 },
});
