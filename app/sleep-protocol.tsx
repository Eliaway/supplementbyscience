...
const styles = StyleSheet.create({
  ...
  scoreDesc: { fontSize: 13, textAlign: "right" },
  questionRow: { flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  questionText: { flex: 1, fontSize: 13, textAlign: "right" },
  ...
  hygieneEmoji: { fontSize: 24 },
  hygieneTitle: { fontSize: 13, fontWeight: "800", textAlign: "right" },
  hygieneDesc: { fontSize: 11, lineHeight: 16, textAlign: "right" },
  ...
  suppTiming: { fontSize: 11, textAlign: "right" },
