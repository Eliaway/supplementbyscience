...
const styles = StyleSheet.create({
  ...
  groupTitle: { fontSize: 15, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  groupSub: { fontSize: 12, textAlign: "right", marginTop: 2, fontFamily: "Cairo" },
  ...
  avoidText: { flex: 1, fontSize: 13, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
