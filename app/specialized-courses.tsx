...
const styles = StyleSheet.create({
  ...
  courseTitle: { fontSize: 16, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  courseSubtitle: { fontSize: 12, textAlign: "right", marginTop: 2, fontFamily: "Cairo" },
  targetRow: { flexDirection: "row-reverse", alignItems: "center", gap: 6, padding: 8, borderRadius: 10, borderWidth: 1 },
  targetRowText: { fontSize: 12, fontWeight: "600", textAlign: "right", fontFamily: "Cairo-Bold" },
  ...
  footerBadgeText: { fontSize: 11, fontWeight: "600", fontFamily: "Cairo-Bold" },
  ...
  detailTitle: { fontSize: 20, fontWeight: "900", fontFamily: "Cairo-Black" },
  detailSubtitle: { fontSize: 13, textAlign: "center", fontFamily: "Cairo" },
  targetBadge: { flexDirection: "row-reverse", alignItems: "center", gap: 6, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12 },
  targetText: { fontSize: 12, fontWeight: "600", textAlign: "right", fontFamily: "Cairo-Bold" },
  ...
  filterChipText: { fontSize: 12, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  itemName: { fontSize: 14, fontWeight: "800", textAlign: "right", flex: 1, fontFamily: "Cairo-Black" },
  priorityBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  priorityBadgeText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
