...
const styles = StyleSheet.create({
  ...
  goalTitle: { fontSize: 13, fontWeight: "700", textAlign: "center" },
  protocolCard: { borderRadius: 16, padding: 14, borderWidth: 1, gap: 10 },
  protocolTitle: { fontSize: 15, fontWeight: "800", textAlign: "right", marginBottom: 4 },
  ...
  phaseTitle: { flex: 1, fontSize: 14, fontWeight: "700", textAlign: "right" },
