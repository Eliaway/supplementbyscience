...
const styles = StyleSheet.create({
  ...
  stackName: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  itemsRow: { flexDirection: "row-reverse", flexWrap: "wrap", gap: 6 },
  itemBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  itemText: { fontSize: 11, fontWeight: "600" },
  benefitText: { fontSize: 12, lineHeight: 18, textAlign: "right" },
  timingText: { fontSize: 12, textAlign: "right" },
  ...
  conflictCombo: { flex: 1, fontSize: 13, fontWeight: "800", textAlign: "right" },
  conflictNote: { padding: 12, fontSize: 12, lineHeight: 18, textAlign: "right" },
  ...
  absorptionIcon: { fontSize: 24 },
  absorptionTip: { fontSize: 15, fontWeight: "800" },
  absorptionSupps: { fontSize: 12, lineHeight: 18, textAlign: "right" },
});
