...
const styles = StyleSheet.create({
  ...
  catName: { fontSize: 14, fontWeight: "800", flex: 1, textAlign: "right" },
  ...
  ruleTitle: { fontSize: 11, textAlign: "right" },
  ruleValue: { fontSize: 12, fontWeight: "800", textAlign: "right" },
  tipsSection: { gap: 6 },
  tipRow: { flexDirection: "row-reverse", alignItems: "flex-start", gap: 6 },
  tipText: { flex: 1, fontSize: 12, textAlign: "right" },
  ...
  signName: { fontSize: 14, fontWeight: "700", textAlign: "right" },
  signMeaning: { fontSize: 12, textAlign: "right" },
  safeBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8, flexShrink: 0 },
  safeText: { fontSize: 11, fontWeight: "700" },
});
