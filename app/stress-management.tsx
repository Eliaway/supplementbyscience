...
const styles = StyleSheet.create({
  ...
  suppName: { fontSize: 15, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  ...
  metaText: { fontSize: 11, fontFamily: "Cairo" },
  mechanism: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
  benefitsRow: { flexDirection: "row-reverse", flexWrap: "wrap", gap: 6 },
  benefitTag: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  benefitText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  levelCard: { borderRadius: 16, overflow: "hidden", borderWidth: 1 },
  levelHeader: { padding: 12 },
  levelTitle: { fontSize: 16, fontWeight: "900", textAlign: "right", fontFamily: "Cairo-Black" },
  levelDesc: { fontSize: 12, textAlign: "right", paddingHorizontal: 12, paddingTop: 8, fontFamily: "Cairo" },
  protocolList: { padding: 12, gap: 8 },
  protocolItem: { flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  protocolText: { fontSize: 13, textAlign: "right", flex: 1, fontFamily: "Cairo" },
});
