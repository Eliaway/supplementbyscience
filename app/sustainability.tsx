...
const styles = StyleSheet.create({
  ...
  heroText: { fontSize: 14, lineHeight: 22, textAlign: "right" },
  ...
  tipDesc: { fontSize: 13, lineHeight: 20, textAlign: "right" },
  ...
  altSupplement: { fontSize: 14, fontWeight: "800", textAlign: "right", marginBottom: 6 },
  ...
  altBadgeText: { fontSize: 11, fontWeight: "700" },
  altBenefit: { fontSize: 12, textAlign: "right" },
});
