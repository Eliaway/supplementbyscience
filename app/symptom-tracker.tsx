...
const styles = StyleSheet.create({
  ...
  symptomName: { fontSize: 14, fontWeight: "700", textAlign: "right" },
  symptomCat: { fontSize: 11, textAlign: "right" },
  ...
  symptomCategory: { fontSize: 14, fontWeight: "700" },
  ...
  suppNumText: { fontSize: 12, fontWeight: "800" },
  suppName: { flex: 1, fontSize: 14, fontWeight: "700", textAlign: "right" },
  causeRow: { borderRadius: 12, padding: 12, borderWidth: 1, flexDirection: "row-reverse", alignItems: "center", gap: 10 },
  causeText: { flex: 1, fontSize: 13, textAlign: "right" },
  ...
  suppRankText: { fontSize: 12, fontWeight: "800" },
  topSuppName: { flex: 1, fontSize: 14, fontWeight: "700", textAlign: "right" },
