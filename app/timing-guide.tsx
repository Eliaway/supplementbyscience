...
const styles = StyleSheet.create({
  ...
  entryName: { fontSize: 15, fontWeight: "800", textAlign: "right", marginBottom: 6 },
  ...
  entryReason: { fontSize: 12, lineHeight: 18, textAlign: "right" },
  sectionTitle: { fontSize: 15, fontWeight: "800", textAlign: "right", marginTop: 4 },
  timeCard: { flexDirection: "row-reverse", alignItems: "center", gap: 10, padding: 12, borderRadius: 12, borderWidth: 1 },
  timeLabel: { fontSize: 14, fontWeight: "700", textAlign: "right" },
  reasonCard: { borderRadius: 12, padding: 14, borderWidth: 1, gap: 8 },
  reasonTitle: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  reasonText: { fontSize: 13, lineHeight: 20, textAlign: "right" },
  itemRow: { flexDirection: "row-reverse", gap: 10, padding: 10, borderRadius: 10, borderWidth: 1 },
  itemText: { flex: 1, fontSize: 13, lineHeight: 18, textAlign: "right" },
  ...
  absorptionLabel: { fontSize: 13 },
  absorptionValue: { fontSize: 15, fontWeight: "800" },
  stackHeader: { borderRadius: 12, padding: 14, borderWidth: 1, marginBottom: 4 },
  stackHeaderText: { fontSize: 13, lineHeight: 20, textAlign: "right" },
  stackCard: { borderRadius: 12, padding: 14, borderWidth: 1, gap: 6 },
  stackTitle: { fontSize: 14, fontWeight: "800", textAlign: "right" },
  stackDesc: { fontSize: 13, lineHeight: 20, textAlign: "right" },
});
