...
const styles = StyleSheet.create({
  ...
  ruleTitle: { flex: 1, fontSize: 14, fontWeight: "800", textAlign: "right" },
  ruleIcon: { width: 44, height: 44, borderRadius: 22, alignItems: "center", justifyContent: "center" },
  ruleReason: { fontSize: 12, lineHeight: 18, textAlign: "right", padding: 10, borderRadius: 10 },
  ...
  supplementTagText: { fontSize: 11, fontWeight: "700" },
  ...
  mealTimeText: { fontSize: 14, fontWeight: "900" },
  mealHeader: { flexDirection: "row-reverse", alignItems: "center", gap: 6 },
  mealLabel: { fontSize: 14, fontWeight: "800" },
