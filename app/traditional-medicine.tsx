...
const styles = StyleSheet.create({
  ...
  systemName: { fontSize: 16, fontWeight: "800", fontFamily: "Cairo-Black" },
  systemOrigin: { fontSize: 12, fontWeight: "600", marginTop: 2, fontFamily: "Cairo-Bold" },
  systemDesc: { fontSize: 12, lineHeight: 18, textAlign: "right", fontFamily: "Cairo" },
  ...
  herbChipText: { fontSize: 11, fontWeight: "600", fontFamily: "Cairo-Bold" },
  ...
  herbNumText: { fontSize: 13, fontWeight: "800", fontFamily: "Cairo-Black" },
  herbInfo: { flex: 1, alignItems: "flex-end" },
  herbName: { fontSize: 14, fontWeight: "800", fontFamily: "Cairo-Black" },
  herbScientific: { fontSize: 11, marginTop: 1, fontFamily: "Cairo" },
  herbUse: { fontSize: 12, textAlign: "right", fontFamily: "Cairo" },
  evidenceMini: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  evidenceMiniText: { fontSize: 10, fontWeight: "700", fontFamily: "Cairo-Bold" },
  evidenceBadge: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 12, alignSelf: "flex-end" },
  evidenceBadgeText: { color: "#fff", fontSize: 13, fontWeight: "700", fontFamily: "Cairo-Bold" },
  detailCard: { borderRadius: 14, padding: 14, borderWidth: 1, gap: 8 },
  detailHeader: { flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  detailLabel: { fontSize: 12, fontWeight: "600", fontFamily: "Cairo-Bold" },
  detailValue: { fontSize: 14, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
  cautionCard: { flexDirection: "row-reverse", alignItems: "flex-start", gap: 10, padding: 14, borderRadius: 14, borderWidth: 1 },
  cautionText: { flex: 1, fontSize: 13, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
  legendCard: { borderRadius: 14, padding: 14, borderWidth: 1, gap: 10 },
  legendTitle: { fontSize: 14, fontWeight: "800", textAlign: "right", marginBottom: 4, fontFamily: "Cairo-Black" },
  legendRow: { flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  legendDot: { width: 12, height: 12, borderRadius: 6 },
  legendText: { fontSize: 13, fontFamily: "Cairo" },
});
