...
const styles = StyleSheet.create({
  ...
  avgNum: { fontSize: 40, fontWeight: "900" },
  starsRow: { flexDirection: "row-reverse" },
  totalText: { fontSize: 12, textAlign: "right" },
  ...
  ratingBarLabel: { fontSize: 11, minWidth: 20, textAlign: "right" },
  controlsRow: { gap: 8 },
  ...
  reviewUser: { fontSize: 13, fontWeight: "800", textAlign: "right" },
  reviewDate: { fontSize: 11, textAlign: "right" },
  suppTag: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, alignSelf: "flex-end" },
  suppTagText: { fontSize: 12, fontWeight: "700" },
  goalTag: { alignSelf: "flex-end" },
  goalTagText: { fontSize: 11 },
  reviewComment: { fontSize: 13, lineHeight: 20, textAlign: "right" },
