...
const styles = StyleSheet.create({
  ...
  inputLabel: { fontSize: 12, fontWeight: "600", textAlign: "right", fontFamily: "Cairo-Bold" },
  input: { borderRadius: 10, borderWidth: 1, paddingHorizontal: 12, paddingVertical: 10, fontSize: 16, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  bmiValue: { fontSize: 32, fontWeight: "900", fontFamily: "Cairo-Black" },
  bmiCategory: { fontSize: 16, fontWeight: "700", fontFamily: "Cairo-Bold" },
  ...
  protocolDesc: { fontSize: 12, lineHeight: 18, fontFamily: "Cairo" },
