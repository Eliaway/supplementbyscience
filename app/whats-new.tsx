...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: 15, fontWeight: "800", textAlign: "right", fontFamily: "Cairo-Black" },
  cardDate: { fontSize: 11, textAlign: "right", marginTop: 2, fontFamily: "Cairo" },
  badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  badgeText: { fontSize: 11, fontWeight: "700", fontFamily: "Cairo-Bold" },
  cardDesc: { fontSize: 13, lineHeight: 20, textAlign: "right", fontFamily: "Cairo" },
});
